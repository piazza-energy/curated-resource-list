...
function searchCharacters(query, bookmarks) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    if (query.length > 2) {
      ...
      output = __jsx("div", {
      ...
      }, "Your search for ", query, " produced ", count, " results"), Object.keys(results).map(function (cat, iCat) {
        __jsx("div", {
          __self: _this2,
          __source: {
            fileName: _jsxFileName,
        ...
        }, results[cat].length, " results in ", __jsx(_category_link__WEBPACK_IMPORTED_MODULE_3__["default"], {
          name: cat,
          __self: _this2,
          __source: {
            fileName: _jsxFileName,
        ...
        })), results[cat].map(function (bookmark, iBookmark) {
          return __jsx(_bookmark_link__WEBPACK_IMPORTED_MODULE_4__["default"], Object(_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({
            key: "".concat(iCat, "_").concat(iBookmark)
          }, bookmark, {
            __self: _this2,
            __source: {
              fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.0b1de63a2a0f974bf02b.hot-update.js.map