...
- European Energy Flexibility Platform and Interface (EF-Pi) [link flexible energy](https://flexible-energy.eu/) - [link docs](http://fpai-ci.sensorlab.tno.nl/builds/fpai-documentation/development/html/)
...
- [efergy](https://efergy.com/) clamps, controlled sockets, webapp
- [sense](https://sense.com/) clamps, installed in the fuse box
- [geotogether](https://www.geotogether.com/) clamps, controlled sockets, thermostats, solar (mentioned in the solar/battery section by Ikea, indicates when to switch on/off appliances), consumer + business
- [smappee](https://www.smappee.com/) clamps, webapp, claims to disaggregate by appliance
- [neur.io](https://www.neur.io/) clamps, webapp, solar
- [rialtocomfort](https://www.rialtocomfort.com/) clamps, thermostats, webapp
- Monitor, mainly a mobile app? Based in Sweden, Not sure how it works [watty](https://watty.io/order)
...
- eloncity - Mega platform (under development) Singapore based with blockchain and devices [link](https://eloncity.io/)
- Utility API,  Web api platform for energy consumption and bills [link](https://utilityapi.com/)
...
- Cloud software for demand side response with AI [Upside energy](https://upsideenergy.co.uk/about-us/)
- AI + API but don’t think they have anything released open source [Qbots](https://www.qbots.ai/#how)
...
- Platform for solar workflow management, from planning, financing, installation, monitoring, support: [Sighten](http://www.sighten.io/)
- Off-peak energy trading platform, funded by national grid [leap](https://leap.ac/)
...
- Won’t link the usual suspects: nest, hive
...
## NGO / Organisations / activism (bit of a bodged together category)
- CDP is a not-for-profit charity that runs the global disclosure system for investors, companies, cities, states and regions to manage their environmental impacts [link](https://www.cdp.net/en)
...
- Investment risk management in solar, a platform [kwhanalytics](http://www.kwhanalytics.com/)
...
- [landlordenergysolutions](http://www.landlordenergysolutions.org/) is a new startup developing batteries and renewable projects at large for landlords
- [PBX](https://www.power-blox.com/) the Swiss guys working on projects for Africa / developing countries
